            ...
            <div className="w-[380px] pt-3">
                <Dialog>
                    ...
                    <DialogContent className="bg-[var(--bg-sandpaper)] w-[560px] h-[720px] py-5 px-15">
                        <DialogHeader>
                            <DialogTitle className="mb-4 flex justify-center">Edit Profile</DialogTitle>
                            <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="relative flex flex-col justify-between h-full">
                                ...
                                <div className="flex justify-between mt-4">
                                    ...
                                    <DialogClose
                                        className="w-[125px] h-[37px] flex justify-center items-center text-white"
                            ...
                            <Button type="button" className="w-[155px] flex justify-center mt-4" onClick={handleLogout}>
                                Logout
                            </Button>
                        </DialogHeader>
                    </DialogContent>
