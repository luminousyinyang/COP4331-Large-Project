...
function ProfileBar ({ className, firstName, lastName, about, instaLink, spotifyLink, twitterLink, ...props }: ProfileBarProps) {
    return (
            ...
            <div className="flex flex-col gap-2 w-[280px]">
                ...
                <div className="flex flex-col gap-3">
                    <a href={instaLink} className="flex gap-5 cursor-pointer group relative">
                        ...
                        <div className="absolute bottom-[-3px] left-0 w-0 h-[3px] bg-[var(--bg-navy)] transition-all duration-300 group-hover:w-[75%]"></div>
                    </a>
