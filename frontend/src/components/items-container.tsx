...
function ItemContainer({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div className={cn("flex flex-col w-[780px] h-auto gap-3 bg-[var(--bg-pale-white)] border rounded-2xl items-center justify-start flex-start", className)} {...props}>
            <div className="flex justify-center items-center gap-8 mt-6 h-[195px] w-[720px] border rounded-2xl bg-white shadow-[0_0_20px_rgba(0,0,0,0.2)]">
